...
class Ocean
{
    ...
    float wave_exp; /* Power of waves generated by an object's wake. wave_exp >= 1.0, suggested is 2.0 */
...
public:
    ...
    \param wavePower the strength of an object's wake; wavePower >= 1.0, suggested is 2.0
    ...
    */
    Ocean(int verticesX, int verticesY, float width, float length, float heightScale, float dt, float alpha, float sigma, float wavePower, INode* parentNode, INode** collisionNodes, int numCollisionNodes);
    ~Ocean(void);
