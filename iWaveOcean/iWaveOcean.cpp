...
static ParamBlockDesc2 iwaveocean_param_blk ( iwaveocean_params, _T("params"),  0, GetiWaveOceanDesc(), 
    ...
    pb_width,			_T("width"),		    TYPE_FLOAT,		0,          		IDS_WIDTH,
        ...
        p_ui,			pb_map_size,            TYPE_SPINNER,   EDITTYPE_FLOAT,	    IDC_WIDTH_EDIT,		    IDC_WIDTH_SPIN,			0.1f,
        p_end,
    pb_length,			_T("length"),		    TYPE_FLOAT,		0,          		IDS_LENGTH,
        p_default,		100.0f,
        p_range,	    MIN_LENGTH,1000000.0f,
        p_ui,			pb_map_size,            TYPE_SPINNER,   EDITTYPE_FLOAT,	    IDC_LENGTH_EDIT,	    IDC_LENGTH_SPIN,		0.1f,
        p_end,
    ...
    pb_sim_start,       _T("sim_start"),        TYPE_INT,       0,                  IDS_START_FRAME,
        p_default,      0,
        p_range,        0, INT_MAX,
        p_ui,           pb_map_dynamics,        TYPE_SPINNER,   EDITTYPE_INT,       IDC_START_EDIT,         IDC_START_SPIN,         0.05f,
        p_end,
    pb_sim_length,      _T("sim_length"),       TYPE_INT,       0,                  IDS_FRAME_COUNT,
        p_default,      100,
        p_range,        1, INT_MAX,
        p_ui,           pb_map_dynamics,        TYPE_SPINNER,   EDITTYPE_INT,       IDC_FRAMES_EDIT,        IDC_FRAMES_SPIN,        0.05f,
        p_end,
    ...
    pb_ambient_scale,   _T("ambient_scale"),	TYPE_FLOAT,		P_ANIMATABLE,		IDS_AMBIENT_SCALE,
        ...
        p_ui,			pb_map_ambient,         TYPE_SPINNER,   EDITTYPE_FLOAT,	    IDC_SCALE_EDIT,		    IDC_SCALE_SPIN,			0.1f,
        p_end,
    pb_amplitude, 		_T("amplitude"), 	    TYPE_FLOAT, 	P_ANIMATABLE, 		IDS_AMPLITUDE, 
        p_default, 		0.001f, 
        p_range, 		0.0f,1.0f, 
        p_ui, 			pb_map_ambient,         TYPE_SPINNER,	EDITTYPE_FLOAT,     IDC_AMPLITUDE_EDIT,	    IDC_AMPLITUDE_SPIN,		0.001f, 
        p_end,
    pb_min_wave_size,	_T("min_wave_size"),    TYPE_FLOAT,		P_ANIMATABLE,		IDS_MIN_SIZE,
        p_default,		1.0f,
        p_range,		0.0f,50.0f,
        p_ui,			pb_map_ambient,         TYPE_SPINNER,	EDITTYPE_FLOAT,	    IDC_MIN_SIZE_EDIT,	    IDC_MIN_SIZE_SPIN,		0.1f,
        p_end,
    pb_wind_speed,		_T("wind_speed"),	    TYPE_FLOAT,		P_ANIMATABLE,		IDS_SPEED,
        p_default,		2.0f,
        p_range,		0.0f,20.0f,
        p_ui,			pb_map_ambient,         TYPE_SPINNER,	EDITTYPE_FLOAT,	    IDC_SPEED_EDIT,		    IDC_SPEED_SPIN,			0.1f,
        p_end,
    ...
    pb_duration,		_T("duration"),	        TYPE_INT,	    0,          		IDS_DURATION,
        p_default,		1000,
        p_range,		20,1000000,
        p_ui,			pb_map_ambient,         TYPE_SPINNER,	EDITTYPE_INT,	    IDC_DURATION_EDIT,      IDC_DURATION_SPIN,  	0.05f,
        p_end,
